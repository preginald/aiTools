...
initial = """
Tell me a choose your own adventure story. The story is set in a magical mushroom universe. The genre is comedy and adventure. Give me multiple choices. Your response must have the following JSON structure: 
`{
    "story": "Story content...",
    "options": [
        {
